...
const FP_LINK_TASKS = [
  { id: 'amin_az', url: 'https://who-tma.github.io/AminAz/', title: 'Daily Check-in', icon: '📅' },
  { id: 'luckyroom', url: 'https://t.me/coin_earn_2026bot/luckyroom?startapp=6413998670', title: 'Lucky Room', icon: '🎰' },
  { id: 'gram_piarbot', url: 'https://t.me/gram_piarbot?start=6413998670', title: 'Gram Bot', icon: '💎' },
];
...
function fpRenderLinkTasks() {
  ...
  FP_LINK_TASKS.forEach(t => {
    ...
    card.innerHTML = `
      ...
      <button class="fp-task-btn" id="fpLinkBtn_${t.id}" ${remain > 0 ? 'disabled' : ''}>${remain > 0 ? 'Wait' : 'Go'}</button>
    `;
